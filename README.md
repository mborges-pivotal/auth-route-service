...
$ ./mvnw clean package
$ cf push --no-start
$ cf bind-service auth-route-service cf-sso-service
$ cf start auth-route-service 
```
...
```bash
$ cf create-user-provided-service auth-route-service -r https://<AUTH-ROUTE-SERVICE-ADDRESS>
```
